...
//       const response = await fetch(`${API_BASE_URL}/api/v1/internships`, {
//         method: 'POST',
//         body: payload,
//       });
...
//         >
//           {isSubmitting ? 'Submitting Application...' : 'Apply for Internship →'}
//         </button>
//       </form>
//     </div>
//   );
...
const ApplyForInternshipForm: React.FC = () => {
  ...
  // React portal safely attach karne ke liye mount checking
  useEffect(() => {
    setMounted(true);
  }, []);
  ...
  return (
    <>
      {/* React Portal: Toast pure viewport ke top-right lock par render hoga */}
      {mounted && ReactDOM.createPortal(
        <Toaster 
          ...
          toastOptions={{
            duration: 4000,
            style: {
              background: '#1c1917', // Dark charcoal/black sleek professional background
              color: '#ffffff',
              fontSize: '14px',
              fontWeight: '500',
              borderRadius: '8px',
            ...
            success: {
              iconTheme: {
                primary: '#22c55e', // Green check badge
                secondary: '#ffffff',
              },
            },
            error: {
