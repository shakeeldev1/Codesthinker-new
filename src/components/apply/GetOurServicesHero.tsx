...
const GetOurServicesHero: React.FC = () => {
    const stats: StatItem[] = [
        { label: "Expert Team", val: "50+", icon: <Users className="w-5 h-5 text-[#F69A20]" /> },
    ...
    return (
        <section className="relative w-full min-h-[100dvh] pt-28 pb-16 md:pt-32 lg:pt-12 flex items-center overflow-hidden font-sans">
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
                    ...
                    >
                        ...
                        <h1 className="text-5xl lg:text-5xl font-bold text-white leading-[1.1] tracking-tight">
                            ...
                            <span className="text-[#F69A20]">With Expert Services</span>
                        </h1>
                    ...
                    >
                        <div className="bg-white/10 backdrop-blur-xl p-4 rounded-3xl ring-1 ring-white/20 shadow-2xl">
                            <img
                                src="https://images.pexels.com/photos/8134069/pexels-photo-8134069.jpeg"
                                alt="Team collaborating"
                                className="w-full max-w-[500px] aspect-[5/4] object-cover rounded-2xl"
                            />
                        </div>
                    </motion.div>
                </div>
...
export default GetOurServicesHero;