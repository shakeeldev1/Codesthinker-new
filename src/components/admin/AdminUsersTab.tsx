                ...
                <tr key={user.id} className="hover:bg-slate-50/80 transition-all">
                  <td className="py-4 px-6">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-lg bg-[#08061E] text-amber-400 flex items-center justify-center font-black text-xs uppercase border border-slate-200 shadow-xs">
                        {user.username[0]}
                      </div>
                      <div>
                  ...
                  <td className="py-4 px-6">
                    <div className="flex flex-wrap gap-1 max-w-xs">
                      {user.permissions.slice(0, 3).map(p => (
                        <span key={p} className="text-[9px] font-bold bg-slate-100 text-slate-700 px-2 py-0.5 rounded border border-slate-200">
                          {p.replace(/_/g, ' ')}
                        </span>
                      ))}
                      {user.permissions.length > 3 && (
                        <span className="text-[9px] text-amber-600 font-bold">+{user.permissions.length - 3} more</span>
                      )}
                    </div>
                  </td>
                  <td className="py-4 px-6">
                  ...
                  <td className="py-4 px-6">
                    <div className="flex items-center justify-end gap-1">
                      ...
                      {user.isRoot && (
                        <span className="text-[9px] text-amber-700 font-extrabold uppercase tracking-wider bg-amber-50 border border-amber-200 px-2 py-0.5 rounded">Root — Protected</span>
                      )}
                    </div>
                  </td>
                </tr>
