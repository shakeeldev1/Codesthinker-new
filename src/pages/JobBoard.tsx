...
const JobBoard: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#07051D] via-[#0c0838] to-[#07051D] text-white relative overflow-hidden flex flex-col items-center py-20 px-6">
      ...
      >
        <defs>
          <pattern id="grid-job" width="48" height="48" patternUnits="userSpaceOnUse">
            <path d="M 48 0 L 0 0 0 48" fill="none" stroke="#F59C24" strokeWidth="1" />
          </pattern>
        </defs>
        <rect width="1440" height="1200" fill="url(#grid-job)" />
      </svg>
      ...
      <div className="relative z-10 w-full max-w-6xl">
        <header className="text-center mb-24">
          ...
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6">
            Current <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-amber-300 to-amber-500">Openings</span>
          </h1>
